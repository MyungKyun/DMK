...
template<typename... Args>
inline void spdlog::logger::log(const char* fileName, uint32_t line, level::level_enum lvl, const char *fmt, const Args &... args)
{
...
inline void spdlog::logger::log(const char* fileName, uint32_t line, level::level_enum lvl, const char *msg)
{
    log(source_loc{fileName, line}, lvl, msg);
}
...
template<typename... Args>
inline void spdlog::logger::trace(const char* fileName, uint32_t line, const char *fmt, const Args &... args)
{
    log(fileName, line, level::trace, fmt, args...);
}

template<typename... Args>
inline void spdlog::logger::debug(const char* fileName, uint32_t line, const char *fmt, const Args &... args)
{
    log(fileName, line, level::debug, fmt, args...);
}

template<typename... Args>
inline void spdlog::logger::info(const char* fileName, uint32_t line, const char *fmt, const Args &... args)
{
    log(fileName, line, level::info, fmt, args...);
}

template<typename... Args>
inline void spdlog::logger::warn(const char* fileName, uint32_t line, const char *fmt, const Args &... args)
{
    log(fileName, line, level::warn, fmt, args...);
}

template<typename... Args>
inline void spdlog::logger::error(const char* fileName, uint32_t line, const char *fmt, const Args &... args)
{
    log(fileName, line, level::err, fmt, args...);
}

template<typename... Args>
inline void spdlog::logger::critical(const char* fileName, uint32_t line, const char *fmt, const Args &... args)
{
