...
public:
    ...
    void log(const char* fileName, uint32_t line, level::level_enum lvl, const char *fmt, const Args &... args);

    template<typename... Args>
    void log(source_loc loc, level::level_enum lvl, const char *fmt, const Args &... args);

    void log(const char* fileName, uint32_t line, level::level_enum lvl, const char *msg);

    void log(source_loc loc, level::level_enum lvl, const char *msg);

    template<typename... Args>
    void trace(const char* fileName, uint32_t line, const char *fmt, const Args &... args);

    template<typename... Args>
    void debug(const char* fileName, uint32_t line, const char *fmt, const Args &... args);

    template<typename... Args>
    void info(const char* fileName, uint32_t line, const char *fmt, const Args &... args);

    template<typename... Args>
    void warn(const char* fileName, uint32_t line, const char *fmt, const Args &... args);

    template<typename... Args>
    void error(const char* fileName, uint32_t line, const char *fmt, const Args &... args);

    template<typename... Args>
    void critical(const char* fileName, uint32_t line, const char *fmt, const Args &... args);
